...
/**
 * gtb-ingenierie-hero controller
 */

const { createCoreController } = require('@strapi/strapi').factories;
const mailer = require('../../../lib/mailer');

module.exports = createCoreController('api::gtb-ingenierie-hero.gtb-ingenierie-hero', ({ strapi }) => ({
  async create(ctx) {
    const response = await super.create(ctx);
    const data = await strapi.entityService.findOne(
      'api::gtb-ingenierie-hero.gtb-ingenierie-hero',
      response.data.id
    );
