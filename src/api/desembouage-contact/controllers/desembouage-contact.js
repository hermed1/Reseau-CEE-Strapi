...
/**
 * desembouage-contact controller
 */

const { createCoreController } = require('@strapi/strapi').factories;
const mailer = require('../../../lib/mailer');

module.exports = createCoreController('api::desembouage-contact.desembouage-contact', ({ strapi }) => ({
  async create(ctx) {
    const response = await super.create(ctx);
    const data = await strapi.entityService.findOne(
      'api::desembouage-contact.desembouage-contact',
      response.data.id
    );
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #03A9F4; font-weight: 600; margin-top: 1px;">
                  <a href="https://desembouage-collectif.fr" style="color: #03A9F4; text-decoration: none;">desembouage-collectif.fr</a>
                </div>
              </div>
            </div>
