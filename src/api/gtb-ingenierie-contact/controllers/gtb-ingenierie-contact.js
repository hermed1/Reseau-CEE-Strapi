...
/**
 * gtb-ingenierie-contact controller
 */

const { createCoreController } = require('@strapi/strapi').factories;
const mailer = require('../../../lib/mailer');

module.exports = createCoreController('api::gtb-ingenierie-contact.gtb-ingenierie-contact', ({ strapi }) => ({
  async create(ctx) {
    const response = await super.create(ctx);
    const data = await strapi.entityService.findOne(
      'api::gtb-ingenierie-contact.gtb-ingenierie-contact',
      response.data.id
    );
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #2E7D32; font-weight: 600; margin-top: 1px;">
                  <a href="https://gtb-ingenierie.fr" style="color: #2E7D32; text-decoration: none;">gtb-ingenierie.fr</a>
                </div>
              </div>
            </div>
