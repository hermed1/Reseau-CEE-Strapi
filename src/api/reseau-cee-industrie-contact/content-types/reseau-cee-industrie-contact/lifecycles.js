// /src/api/reseau-cee-industrie-contact/content-types/reseau-cee-industrie-contact/lifecycles.js
...
module.exports = {
  async afterCreate(event) {
    console.log("[afterCreate] reseau-cee-industrie-contact triggered");
  ...
  async afterUpdate(event) {
    console.log("[afterUpdate] reseau-cee-industrie-contact triggered");
