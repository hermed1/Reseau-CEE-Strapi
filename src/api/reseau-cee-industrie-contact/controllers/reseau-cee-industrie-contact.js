...
/**
 * reseau-cee-industrie-contact controller
 */

const { createCoreController } = require('@strapi/strapi').factories;
const mailer = require('../../../lib/mailer');

module.exports = createCoreController('api::reseau-cee-industrie-contact.reseau-cee-industrie-contact', ({ strapi }) => ({
  async create(ctx) {
    ...
    // COULEUR : Bleu Foncé #1565C0
    // URL : reseau-cee-industrie.fr
    const htmlContent = `
    <div style="background-color: #f4f6f8; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 20px 0;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); overflow: hidden;">
        <div style="background-color: #1565C0; height: 8px;"></div>
        <div style="padding: 25px;">
          ...
          <div style="margin-top: 25px; border: 1px solid #ECEFF1; border-radius: 6px;">
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #1565C0; font-weight: 600; margin-top: 1px;">
                  <a href="https://reseau-cee-industrie.fr" style="color: #1565C0; text-decoration: none;">reseau-cee-industrie.fr</a>
                </div>
              </div>
            </div>
          ...
          <div style="margin-top: 25px;">
            ...
            <div style="background-color: #E3F2FD; border-left: 4px solid #1565C0; padding: 15px; border-radius: 4px; color: #1565C0; font-style: italic; line-height: 1.5; font-size: 14px;">${(data.message || 'Aucun message').replace(/\n/g, '<br>')}</div>
          </div>
