// /src/api/praxis-energie-industrie-contact/content-types/praxis-energie-industrie-contact/lifecycles.js
...
module.exports = {
  async afterCreate(event) {
    console.log("[afterCreate] praxis-energie-industrie-contact triggered");

    const message = buildMessage(
      event.result,
      "Nouveau formulaire reçu (praxis-energie-industrie-contact) :"
    );
  ...
  async afterUpdate(event) {
    console.log("[afterUpdate] praxis-energie-industrie-contact triggered");

    const message = buildMessage(
      event.result,
      "Formulaire mis à jour (praxis-energie-industrie-contact) :"
    );
