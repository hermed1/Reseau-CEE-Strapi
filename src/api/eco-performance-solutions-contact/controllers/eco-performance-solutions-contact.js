...
/**
 * eco-performance-solutions-contact controller
 */

const { createCoreController } = require('@strapi/strapi').factories;
const mailer = require('../../../lib/mailer');

module.exports = createCoreController('api::eco-performance-solutions-contact.eco-performance-solutions-contact', ({ strapi }) => ({
  async create(ctx) {
