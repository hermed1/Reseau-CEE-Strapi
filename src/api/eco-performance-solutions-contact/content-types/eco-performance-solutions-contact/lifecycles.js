// /src/api/eco-performance-solutions-contact/content-types/eco-performance-solutions-contact/lifecycles.js
...
module.exports = {
  async afterCreate(event) {
    console.log("[afterCreate] eco-performance-solutions-contact triggered");

    const message = buildMessage(
      event.result,
      "Nouveau formulaire reçu (eco-performance-solutions-contact) :"
    );
  ...
  async afterUpdate(event) {
    console.log("[afterUpdate] eco-performance-solutions-contact triggered");

    const message = buildMessage(
      event.result,
      "Formulaire mis à jour (eco-performance-solutions-contact) :"
    );
