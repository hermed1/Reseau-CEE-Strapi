...
/**
 * france-calorifugeage-contact controller
 */

const { createCoreController } = require('@strapi/strapi').factories;
const mailer = require('../../../lib/mailer');

module.exports = createCoreController('api::france-calorifugeage-contact.france-calorifugeage-contact', ({ strapi }) => ({
  async create(ctx) {
    const response = await super.create(ctx);
    const data = await strapi.entityService.findOne(
      'api::france-calorifugeage-contact.france-calorifugeage-contact',
      response.data.id
    );
    ...
    // COULEUR : Bleu Nuit #1A237E
    // URL : france-calorifugeage.fr
    const htmlContent = `
    <div style="background-color: #f4f6f8; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 20px 0;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); overflow: hidden;">
        <div style="background-color: #1A237E; height: 8px;"></div>
        <div style="padding: 25px;">
          ...
          <div style="margin-top: 25px; border: 1px solid #ECEFF1; border-radius: 6px;">
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #1A237E; font-weight: 600; margin-top: 1px;">
                  <a href="https://france-calorifugeage.fr" style="color: #1A237E; text-decoration: none;">france-calorifugeage.fr</a>
                </div>
              </div>
            </div>
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #263238; font-weight: 600; margin-top: 1px;">${data.SIRET || 'Non renseigné'}</div>
              </div>
            </div>
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #263238; font-weight: 600; margin-top: 1px;">${data.Sexe ? (data.Sexe === 'monsieur' ? 'M.' : 'Mme') : ''} ${data.Nom || 'Non renseigné'}</div>
              </div>
            </div>
            ...
            <div style="padding: 12px 15px; border-bottom: 1px solid #ECEFF1; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #1A237E; font-weight: 600; margin-top: 1px;">
                  <a href="mailto:${data.email}" style="color: #1A237E; text-decoration: none;">${data.email}</a>
                </div>
              </div>
            </div>
             ...
             <div style="padding: 12px 15px; display: flex; align-items: center;">
              ...
              <div>
                ...
                <div style="font-size: 14px; color: #263238; font-top: 1px;">${data.HoraireDebut || '?'} - ${data.HoraireFin || '?'}</div>
              </div>
            </div>
          </div>
          ...
          <div style="margin-top: 25px;">
            ...
            <div style="background-color: #E8EAF6; border-left: 4px solid #1A237E; padding: 15px; border-radius: 4px; color: #1A237E; font-style: italic; line-height: 1.5; font-size: 14px;">"${(data.message || 'Aucun message').replace(/\n/g, '<br>')}"</div>
          </div>
