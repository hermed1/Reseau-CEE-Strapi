// /src/api/reseau-cee-contact/content-types/reseau-cee-contact/lifecycles.js
...
module.exports = {
  async afterCreate(event) {
    console.log("[afterCreate] reseau-cee-contact triggered");

    const message = buildMessage(
      event.result,
      "Nouveau formulaire reçu (reseau-cee-contact) :"
    );
  ...
  async afterUpdate(event) {
    console.log("[afterUpdate] reseau-cee-contact triggered");

    const message = buildMessage(
      event.result,
      "Formulaire mis à jour (reseau-cee-contact) :"
    );
