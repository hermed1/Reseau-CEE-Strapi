// /src/api/eco-cee-contact/content-types/eco-cee-contact/lifecycles.js
...
module.exports = {
  async afterCreate(event) {
    console.log("[afterCreate] eco-cee-contact triggered");

    const message = buildMessage(
      event.result,
      "Nouveau formulaire reçu (eco-cee-contact) :"
    );
  ...
  async afterUpdate(event) {
    console.log("[afterUpdate] eco-cee-contact triggered");

    const message = buildMessage(
      event.result,
      "Formulaire mis à jour (eco-cee-contact) :"
    );
